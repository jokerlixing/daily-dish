...
**v2.3.2 · 1000 道菜谱，每道使用独立的真实照片。** 支持分类浏览、分页跳转和手机使用；相近成品照片会显示实际菜名与差异说明。功能、分类数量与发布校验说明见 [本版更新记录](docs/catalog-1000-status.md)，[888 道版本记录](docs/catalog-888-status.md) 保留为历史。
